...
// Wraps the real IDirect3D9 returned by the real Direct3DCreate9 so that
// CreateDevice returns a wrapped IDirect3DDevice9.
class D3D9Wrap final : public IDirect3D9 {
public:
    explicit D3D9Wrap(IDirect3D9* real) : m_real(real) {}
    ~D3D9Wrap() {}
